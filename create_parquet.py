...
## @type: DataSink
## @args: [connection_type = "s3", connection_options = {"path": "s3://de-youtube-project-bucket-dev/youtube/processed-csv-data/"}, format = "parquet", transformation_ctx = "datasink4"]
## @return: datasink4
...
datasink4 = glueContext.write_dynamic_frame.from_options(frame = df_final_output, connection_type = "s3", connection_options = {"path": "s3://de-youtube-project-bucket-dev/youtube/processed-csv-data/", "partitionKeys": ["region"]}, format = "parquet", transformation_ctx = "datasink4")
